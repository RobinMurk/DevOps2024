...
def add_humidity_measurement(body):  # noqa: E501
    _db_client = getclient()
    data = body
    ...
    # Get avg humidity data for the
    df = getavg(date)
    field = data["field"]
    print(df)
    value=df.loc[0, 'humidity']
...
def delete_hum_bytimeframe(timeframe):  # noqa: E501
    start = timeframe
...
def get_humidity_bytimeframe(timeframe):  # noqa: E501
    query=""
    ...
    try:
        ...
        # retrieve the humidity records from influxdb    
...
def update_avg_humidity(body):  # noqa: E501
    _db_client = getclient()
    data = body
    print(data)
    date = data["tags"]["date"]
